...
function objectsLoad()
    ...
    table.insert(Objects,
        OBJECT:newRect(world, love.graphics.getWidth() - currentRollImg:getWidth() * smallPropSize + 245, 380, 10, 200,
            "static", 0.235, false))
    table.insert(Objects,
        OBJECT:newRect(world, love.graphics.getWidth() - currentRollImg:getWidth() * smallPropSize + 175,
            love.graphics.getHeight() - 145, 100, 5, "static", 0, false))
    table.insert(Objects,
        OBJECT:newRect(world, love.graphics.getWidth() - currentRollImg:getWidth() * smallPropSize + 175,
            love.graphics.getHeight() - 70, 100, 5, "static", 0, false))
    ...
    table.insert(Objects,
        OBJECT:newRect(world, love.graphics.getWidth() - currentRollImg:getWidth() * smallPropSize - 195, 10, 10, 800,
            "static", -0.95, true))    
end
